  ...
  _createClass(InputRange, [{
    ...
    value: function componentDidMount() {
      ...
      window.setTimeout(function () {
        _this2.updateLabelPosition('max');
      }, 0);
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var prevMinValue = prevProps.minValue;
      var prevMaxValue = prevProps.maxValue;

      var isRangeUpdate = prevMinValue !== minValue || prevMaxValue !== maxValue;
    ...
    key: 'calcLabelOffset',
    value: function calcLabelOffset(movingSlider, staticSlider, direction) {
      var trackRect = this.trackClientRect;

      var movingLabel = movingSlider.labelRef;
      var movingRect = movingLabel.rect;
      var movingOffset = movingLabel.state.offsetLeft;
      var labelOffset = movingSlider.props.labelOffset;

      var staticLabel = staticSlider.labelRef;
      var staticRect = staticLabel.rect;

      // Check collision between labels
      var collisionDiff = undefined;
      ...
      if (collisionDiff < COLLISION_GAP) {
        var offset = direction === 'left' ? collisionDiff - COLLISION_GAP : COLLISION_GAP - collisionDiff;
        ...
        var minDiff = movingRect.left - movingOffset - trackRect.left;
    ...
    value: function updateLabelPosition() {
      var movingKey = arguments.length <= 0 || arguments[0] === undefined ? 'min' : arguments[0];
      var _refs = this.refs;
      var sliderMin = _refs.sliderMin;
      var sliderMax = _refs.sliderMax;
    ...
    value: function formatLabel(labelValue) {
      ...
      var formatLabel = _props2.formatLabel;
      var labelPrefix = _props2.labelPrefix;
      var labelSuffix = _props2.labelSuffix;
